...
import { Star, MapPin, Phone, Mail, Clock, Truck, Package, Plus, Edit, Trash2, ShoppingCart, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Shop Info */}
            <div className="lg:col-span-2">              <div className="flex justify-between items-start mb-4">
                <div>
              ...
              </div>              <p className="text-gray-600 dark:text-gray-300 mb-6">{shop.description}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Regular products section for customers and full product view */}        <div className="flex justify-between items-center mb-6">
          <div>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              >                {/* Product Image */}
                ...
                <div className="p-4">                  <div className="flex justify-between items-start mb-2">
                  ...
                  </div><p className="text-gray-600 dark:text-gray-300 text-sm mb-3 line-clamp-2">{product.description}</p>
